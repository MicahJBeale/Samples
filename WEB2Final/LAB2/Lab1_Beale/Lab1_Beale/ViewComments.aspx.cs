...
namespace Lab1_Beale
{
    public partial class ViewComments : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string selectGrid = "SELECT Items.ItemName AS Item, Comments.CommentRemarks AS Review, Categories.CategoryName AS Category FROM Items INNER JOIN Categories ON Items.CategoryID = Categories.CategoryID INNER JOIN Comments ON Items.CommentID = Comments.CommentID";
